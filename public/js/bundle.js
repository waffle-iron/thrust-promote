...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsNewJs = __webpack_require__(197);

	var _componentsNewJs2 = _interopRequireDefault(_componentsNewJs);

	var App = _react2['default'].createClass({
			displayName: 'App',

			render: function render() {
					return _react2['default'].createElement('div', { className: 'container' }, _react2['default'].createElement('div', { className: 'container nav-container' }, _react2['default'].createElement('nav', { className: 'navbar' }, _react2['default'].createElement('div', { className: 'container' }, _react2['default'].createElement('ul', { className: 'nav-list' }, _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: 'app' }, 'Home')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: 'login' }, 'Login')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: 'new' }, 'New')))))), _react2['default'].createElement('div', { className: 'container main-container' }, _react2['default'].createElement(_reactRouter.RouteHandler, null)));
			}
	});

	var routes = _react2['default'].createElement(_reactRouter.Route, { name: 'app', path: '/', handler: App }, _react2['default'].createElement(_reactRouter.Route, { name: 'login', path: '/login', handler: _componentsLoginJs2['default'] }), _react2['default'].createElement(_reactRouter.Route, { name: 'new', path: '/new', handler: _componentsNewJs2['default'] }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', null, 'Coming Soon');
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var New = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement("div", null, _react2["default"].createElement("form", null, _react2["default"].createElement("input", { name: "soundcloud_url", placeholder: "Soundcloud URL" })));
	  }
	});
